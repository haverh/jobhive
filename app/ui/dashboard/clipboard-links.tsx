      ...
      {logosClipboards.map((clip) => {
        ...
        if ( links[type]?.length > 0 ) {
          ...
          return (
            <button 
              key={clip.name}
              className="bg-white dark:bg-[#1F1F1F] h-[40px] w-full flex justify-center items-center rounded hover:bg-yellow-100 dark:hover:bg-yellow-900 sm:h-[48px]"
            ...
            >
              ...
              <Image src={theme === 'dark' ? clip.iconDark : clip.icon} alt={alt} width={35} height={35}
